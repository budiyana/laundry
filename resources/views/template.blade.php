        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="beranda">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class='fas fa-tshirt' style='font-size:36px'></i>
                </div>
                <div class="sidebar-brand-text mx-3">Laundry 6 </div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('Outlet.index')}}" >
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('Outlet.index')}}" >
                    <i class='fas fa-store-alt-slash' style='font-size:20px'></i>
                    <span>Outlet</span>
                </a>
            </li
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <a href="/logout" <i class='fas fa-sign-out-alt' style='font-size:15px'></i>Log Out</a>
